...
@Component({
  selector: 'app-analyze-engagement',
  templateUrl: './analyze-engagement.component.html',
  styleUrls: ['./analyze-engagement.component.scss']
})
export class AnalyzeEngagementComponent implements OnInit {
  ...
  getChart() {
    let chart = am4core.create("chartdiveng", am4charts.XYChart);
  ...
  getChart1() {
    let chart = am4core.create("chartdiveng1", am4charts.XYChart);
