...
import { ROUTES, ROUTESUSER, BUSROUTES } from "../../shared/menu/menu-items";
import { AuthService } from "src/app/shared/services/auth/auth.service";
import { BusRoutes } from "src/app/core/bus/bus.routing";
...
export class SidebarComponent implements OnInit {
  imgLogo = "assets/img/logo/kpj-logo.png";
  ...
  ngOnInit() {
    this.href = this.router.url.slice(0, 5);
