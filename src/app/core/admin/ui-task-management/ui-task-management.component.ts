...
@Component({
  selector: "app-ui-task-management",
  templateUrl: "./ui-task-management.component.html",
  styleUrls: ["./ui-task-management.component.scss"],
})
export class UiTaskManagementComponent implements OnInit, OnDestroy {
  // Table
