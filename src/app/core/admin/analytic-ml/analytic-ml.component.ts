...
@Component({
  selector: "app-analytic-ml",
  templateUrl: "./analytic-ml.component.html",
  styleUrls: ["./analytic-ml.component.scss"],
})
export class AnalyticMlComponent implements OnInit, OnDestroy {
  // Chart
  chart: any;
  chart1: any;
  chart2: any;
