...
@Component({
  selector: "app-ehr-viewer",
  templateUrl: "./ehr-viewer.component.html",
  styleUrls: ["./ehr-viewer.component.scss"],
})
export class EhrViewerComponent implements OnInit, OnDestroy {
  // Toggle
