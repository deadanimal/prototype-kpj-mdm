...
export declare class TabViewNav {
    ...
    static ɵfac: ɵngcc0.ɵɵFactoryDef<TabViewNav>;
    static ɵcmp: ɵngcc0.ɵɵComponentDefWithMeta<TabViewNav, "[p-tabViewNav]", never, {
...
export declare class TabPanel implements AfterContentInit, OnDestroy {
    ...
    selected: boolean;
    ngOnDestroy(): void;
    static ɵfac: ɵngcc0.ɵɵFactoryDef<TabPanel>;
    static ɵcmp: ɵngcc0.ɵɵComponentDefWithMeta<TabPanel, "p-tabPanel", never, {
    "cache": "cache";
...
export declare class TabView implements AfterContentInit, BlockableUI {
    ...
    activeIndex: number;
    static ɵfac: ɵngcc0.ɵɵFactoryDef<TabView>;
    static ɵcmp: ɵngcc0.ɵɵComponentDefWithMeta<TabView, "p-tabView", never, {
    "orientation": "orientation";
