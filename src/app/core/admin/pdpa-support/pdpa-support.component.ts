...
@Component({
  selector: "app-pdpa-support",
  templateUrl: "./pdpa-support.component.html",
  styleUrls: ["./pdpa-support.component.scss"],
})
export class PdpaSupportComponent implements OnInit, OnDestroy {
  // Table
  ...
  listCustomer: any = [
    {
      id: "415796",
      name: "Diana",
      subject: "Update Patient Medical Record",
      status: "ap",
    ...
    },
    {
      id: "415796",
      name: "Aishah",
      subject: "Access Supplier Billing Record",
      status: "rj",
      created_at: "2019-07-27T01:07:14Z",
    },
    {
      id: "415796",
      name: "Kamarul",
      subject: "Delete Patient Medical Record",
      status: "rj",
      created_at: "2019-07-27T01:07:14Z",
    },
  ];
