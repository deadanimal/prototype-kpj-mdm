...
@Component({
  selector: "app-ds-data-survivorship",
  templateUrl: "./ds-data-survivorship.component.html",
  styleUrls: ["./ds-data-survivorship.component.scss"],
})
export class DsDataSurvivorshipComponent implements OnInit, OnDestroy {
  // Table
