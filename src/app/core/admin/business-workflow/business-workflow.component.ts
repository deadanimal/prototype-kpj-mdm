...
@Component({
  ...
  templateUrl: "./business-workflow.component.html",
  styleUrls: ["./business-workflow.component.scss"],
})
export class BusinessWorkflowComponent implements OnInit, OnDestroy {
  // Table
