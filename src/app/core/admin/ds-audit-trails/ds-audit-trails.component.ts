...
@Component({
  selector: "app-ds-audit-trails",
  templateUrl: "./ds-audit-trails.component.html",
  styleUrls: ["./ds-audit-trails.component.scss"],
})
export class DsAuditTrailsComponent implements OnInit, OnDestroy {
  // Chart
  chart: any;
